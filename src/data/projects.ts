...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      "/assets/img-bata/home-page.webp",
      "/assets/img-bata/product-list-user.webp",
      "/assets/img-bata/products-detail-user.webp",
      "/assets/img-bata/cart-detail-user.webp",
      "/assets/img-bata/login.webp",
      "/assets/img-bata/register.webp",
      "/assets/img-bata/user-profile.webp",
      "/assets/img-bata/dashboard-admin.webp",
      "/assets/img-bata/products-list-admin.webp",
      "/assets/img-bata/create-product.webp",
      "/assets/img-bata/edit-product.webp",
      "/assets/img-bata/database.webp",
      "/assets/img-bata/404.webp",
    ],
    youtubeId: "",
